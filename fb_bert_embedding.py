...
#'''
for max_triplets_num in [10]:   
    
    if sampling == 'random':
        llm_res_path = './llm_response/FB15k/mpnet_llama3-1/fb15k_llm_res_t{}_random.tsv'.format(str(max_triplets_num))       
        ...
        llm_res_path = './llm_response/FB15k/mpnet_llama3-1/fb15k_llm_res_t{}_cluster.tsv'.format(str(max_triplets_num))       
...
file_path = './datasets/FB15k/mpnet/fb15k_merge_cluster_t10.tsv'  
