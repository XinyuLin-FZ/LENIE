...
json_path = './datasets/MUSIC10K/artist_familiarity/rel_name.json'  
rel_id2relation = read_json(json_path)

file_path='./datasets/MUSIC10K/artist_familiarity/node_info_artist_familiarity.tsv'
...
subject_id2text = get_node_id2texts(ht2r_dict,node_id2name_dict,rel_id2relation, max_triplets_num=t,sampling_method='cluster')  #cluster random

tri_text = get_triplets_text(subject_id2text)

des_path = './datasets/MUSIC10K/node_info_artist_familiarity.tsv'  
output_path = './datasets/MUSIC10K/lxy_0817_mpnet/music10k_merge_cluster_t{}.tsv'.format(t)  
