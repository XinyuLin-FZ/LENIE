...
subject_id2text = get_node_id2texts(ht2r_dict,node_id2name_dict,rel_id2relation, max_triplets_num=t,sampling_method='cluster')

tri_text = get_triplets_text(subject_id2text)
des_path = './datasets/TMDB5K/node_info_full.tsv'  
output_path = './datasets/TMDB5K/lxy_0803_mpnet/tmdb5k_merge_cluster_t{}.tsv'.format(t)  
