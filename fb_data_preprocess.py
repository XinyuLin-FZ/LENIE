...
subject_id2text = get_node_id2texts(triplet2text_dict,mid2node_id_dict,mid2entity_dict,node_id2mid_dict, max_triplets_num=t,sampling_method=sampling_method)

tri_text = get_triplets_text(node_id2mid_dict, subject_id2text)
des_path = './datasets/FB15k/fb15k_description.tsv'  
output_path = './datasets/FB15k/mpnet/fb15k_merge_{}_t{}.tsv'.format(sampling_method,t)  

if not os.path.exists('./datasets/FB15k/mpnet'):
        os.makedirs('./datasets/FB15k/mpnet')
